  ...
  return `    <div class="msgbox reveal">
      ...
      <form id="msgForm" novalidate>
        <div class="msg-row">
          <label>
            <span>Your name</span>
            <input type="text" name="name" required maxlength="60" autocomplete="name">
          </label>
          <label>
            <span>Phone or Instagram</span>
            <input type="text" name="contact" required maxlength="80" placeholder="03 123 456 or @yourname">
          </label>
        </div>
        <label>
          <span>Your message</span>
          <textarea name="body" required maxlength="1200" rows="4" placeholder="What would you like printed?"></textarea>
        </label>
        <input type="text" name="website" tabindex="-1" autocomplete="off" aria-hidden="true" class="hp">
        <div class="msg-foot">
          <button type="submit" class="btn btn-primary">Send message</button>
          <span class="msg-status" id="msgStatus"></span>
        </div>
      </form>
    </div>`;
}
